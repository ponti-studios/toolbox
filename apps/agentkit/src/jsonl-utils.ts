...
// Ported from agent-usage-monitor's jsonl-utils.ts.
// Uses regex factories to avoid shared mutable state on global regex objects.

// ─── Regex factories (fresh instance per call) ──────────────────────
