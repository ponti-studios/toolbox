# Chronicle JSON Contract

`chronicle` uses JSON over stdio between the Rust CLI and the Python engine.
...
```json
{
  ...
  "command": "doctor",
  "args": {
    "config_root": "/Users/example/Library/Application Support/chronicle",
    "cache_root": "/Users/example/Library/Caches/chronicle/models"
  }
}
```
...
```json
{
  ...
  "command": "sync",
  "args": {
    "database_path": "/Users/example/Library/Application Support/chronicle/chronicle.db"
  }
}
```
...
```json
{
  ...
  "args": {
    "format": "jsonl",
    "output_path": "/Users/example/Library/Application Support/chronicle/exports/events.jsonl"
  }
}
```
